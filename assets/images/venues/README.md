...
Overwrite the existing files with your new images (same names). JPG or PNG is fine; if you use PNG, rename to ceremony.png and reception.png and update the file extensions in src/components/Venue.jsx.
